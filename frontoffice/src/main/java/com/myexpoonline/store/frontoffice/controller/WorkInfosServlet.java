...
public class WorkInfosServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        //findFirst.get() récupère la correspondance de filter
        ...
        //    }
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1> Title : " + myWork.getTitle() + "</h1>");
            out.println("<h2> Year : " + myWork.getYear() + "</h2>");
            out.println("<h2> Style : " + myWork.getStyle() + "</h2>");
            out.println("<h2> Author : " + myWork.getAuthor().getName() + "</h2>");
            out.println("<h2> Description : " + myWork.getDescription() + "</h2>");
            out.println("</body>");
            out.println("</html>");
        }
